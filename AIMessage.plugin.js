/**
 * @name AIMessage
 * @description Allows you to generate AI messages in discord, or use it to respond as you!
 * @version 1.0.1
 * @author Meaning
...
const config = {
  ...
  changelog: [
    {
      title: "Added Multi-User Support",
      type: "added",
      items: ["Added the ability to see images", "Using the Name field for OpenAI to distinguish between users"],
    },
    {
...
`;
      ...
      return class AIMessage extends Plugin {
        constructor() {
          super();
          this.models = [
        ...
        onStart() {
          ...
          // Stole this from PreviewMessage Plugin, It does act a lil funny but works.
        ...
        async sendToOpenAI(prompt, model, history = []) {
          ...
          try {
            ...
            const historyMessages = history.map((msg) => ({
              ...
              name: msg.author.replace(/[^a-zA-Z0-9_-]/g, ""),
              content: [
                {
                  type: "text",
                  text: msg.content,
                },
                ...(msg.author !== user && msg.image_urls || []).map((img_url) => ({
                  type: "image_url",
                  image_url: {
                    url: img_url,
                  }
        ...
        getCurrentChannelId() {
          const ChannelStore = BdApi.findModuleByProps(
            "getChannelId",
        ...
        showModal() {
          BdApi.showConfirmationModal(
            "AI Text Generator",
            React.createElement("div", { className: "ai-modal" }, [
              React.createElement(
                "select",
                {
                  ...
                  React.createElement(
                    ...
                    [
                      ...
                      React.createElement("input", {
                        ...
                        defaultValue: "50",
                        onChange: (e) =>
                          (this.messageLimit = parseInt(e.target.value)),
                      }),
                    ]
                  ),
                ]
            ...
            ]),
            {
              ...
              onConfirm: () => {
                if (this.useLastMessage) {
                  ...
                  this.getChannelMessages(channelId, this.messageLimit).then(
                    (history) => {
                      ...
                      this.sendToOpenAI(
                        ...
                        if (response) {
                          ...
                          BdApi.showToast("Response generated!", {
                            type: "success",
                          });
                        } else {
